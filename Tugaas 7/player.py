...
class Hero(ABC):
    def __init__ (self, armor, nama,  health, damage, gambar, posisi_x, posisi_y):
        pygame.init()
        self.__armor = armor
        self.nama = nama
        self.health = health 
    ...
    def defend(self, enemy_damage):
        if self.health > 0 :
            if self.health < self.health_def and self.__armor > 1:
                self.health -= enemy_damage/self.__armor
                self.__armor -=1
...
class Hero_1(Hero):
    def __init__ (self, react_x, react_y):
        ...
        Hero.__init__(self, "Mr.BLACK", 1250, 10, 400 , self.Hero_G, react_x, react_y)
...
class Hero_2(Hero):
    def __init__ (self, react_x, react_y):
        ...
        Hero.__init__(self, "Mr.RED", 1800, 7, 250, self.Hero_G, react_x, react_y)
...
class Hero_3(Hero):
    def __init__ (self, react_x, react_y):
        ...
        Hero.__init__(self, "Mr.BRODY", 2000, 6, 100, self.Hero_G, react_x, react_y)
